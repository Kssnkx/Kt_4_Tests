...
nx.draw(G, pos, with_labels=True, labels=labels, node_size=5000, node_color='red', font_size=10)
...
def create_test_report():
    with open("dog_api_test_report.txt", "w") as report:
        ...
        test_api_endpoint("https://dog.ceo/api/breed/labrador/images/random") 
        report.write("   Passed\n\n")
        ...
        test_api_endpoint("https://dog.ceo/api/breed/collie/list")  #
